...
<?= $this->section('main') ?>
<h1 class="page-title">Data Barang maintenance</h1>
            ...
            <div class="row">
                <div class="col s12">
                    <div class="table-wrapper">
                        <table class="striped highlight responsive-table" id="table-maintenance" width="100%">
                            <thead>
                            </thead>
                            <tbody>
                            </tbody>
...
<div class="popup side" data-page="add">
    ...
    <form action="" id="form-add" class="row">
        ...
        <div class="input-field col s12">
            ...
            <label for="add-jumlah">Jumlah maintenance</label>
        </div>
        <div class="input-field col s12">
            <input name="tanggal" id="add-tanggal" type="date" class="validate" required>
            <label for="add-tanggal">Tanggal maintenance</label>
        </div>
...
<div class="popup side" data-page="edit">
    ...
    <form action="" id="form-edit" class="row">
        ...
        <div class="input-field col s12">
            ...
            <label for="edit-jumlah">Jumlah maintenance</label>
        </div>
        <div class="input-field col s12">
            <input name="tanggal" id="edit-tanggal" type="date" class="validate" required>
            <label for="edit-tanggal">Tanggal maintenance</label>
        </div>
        <div class="row">
            <div class="input-field col s12 center">
                <button class="btn waves-effect waves-light green" type="submit"><i class="material-icons left">save</i>Simpan</button>
